...
const items = [
  ...
  { icon: MessageCircle, label: "WhatsApp", value: `+250788750321`, href: waLink("Hello Coach, I'd like more info about ALI Boxing Club."), cta: "Message on WhatsApp" },
...
export default function CoachContactCard() {
  return (
    <section
      id="coach-contact"
      className="relative border-y border-border bg-gradient-to-b from-background via-card/40 to-background py-32"
    >
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="reveal mb-14 text-center">
          ...
          <h2 className="font-display text-5xl sm:text-6xl">
            Talk To <span className="text-gradient-gold">Coach</span> Directly.
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
            Questions about training, schedule or membership? Skip the forms — call, message, or
            drop by the gym today.
          </p>
        </div>
        ...
        <div className="reveal relative overflow-hidden border border-border bg-card diag-slice">
          ...
          <div className="grid gap-px border-t border-border bg-border text-center text-xs uppercase tracking-widest sm:grid-cols-3">
            <div className="bg-background/50 p-4">
              ...
              <span className="text-[color:var(--gold)]">6AM – 9PM</span>
            </div>
            <div className="bg-background/50 p-4">
              <span className="text-muted-foreground">Saturday · </span>
              <span className="text-[color:var(--gold)]">7AM – 6PM</span>
            </div>
            <div className="bg-background/50 p-4">
              <span className="text-muted-foreground">Sunday · </span>
              <span className="text-[color:var(--gold)]">Private only</span>
            </div>
          </div>
        </div>
      </div>
